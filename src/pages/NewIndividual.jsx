...
const NewIndividual = ({ setCurrentBreadcrumb }) => {
  console.log('Rendering NewIndividual component');
  ...
  useEffect(() => {
    try {
      console.log('Setting breadcrumb for NewIndividual component');
      if (setCurrentBreadcrumb) {
        ...
        console.warn('setCurrentBreadcrumb function is not available');
      }
    } catch (error) {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-5xl">
      <div className="mb-6 flex items-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-800">Register New Individual</h1>
      </div>

      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-200 bg-gray-50">
          <h2 className="text-lg font-medium text-gray-800">Individual Information</h2>
          <p className="text-sm text-gray-500">Enter details about the individual</p>
        </div>
