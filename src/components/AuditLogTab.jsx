    ...
    if (actor === 'Diana') {
      return (
        <div className="w-full h-full rounded-full overflow-hidden border-2 border-white">
          <img src="/assets/diana-avatar.png" alt="Diana" className="w-full h-full object-cover transform hover:scale-110 transition-transform duration-200" />
        </div>
      );
    }
    if (actor === 'Fiona') {
      return (
        <div className="w-full h-full rounded-full overflow-hidden border-2 border-white">
          <img src="/assets/fiona-avatar.png" alt="Fiona" className="w-full h-full object-cover transform hover:scale-110 transition-transform duration-200" />
        </div>
      );
    }
        ...
        {filteredLogs.length === 0 ? (
          ...
          filteredLogs.map((log, index) => (
            <div key={index} className="relative mb-8">
              {/* Vertical Timeline Line with gradient for AI agents */}
              ...
              <div className="flex items-start gap-6">
                {/* Actor Icon with enhanced container */}
                ...
                <div className={`flex-1 p-5 border rounded-lg transform hover:scale-[1.01] transition-transform duration-200
                  ...
                  {/* Action Type Badge with enhanced styling */}
                  <div className="mt-3">
